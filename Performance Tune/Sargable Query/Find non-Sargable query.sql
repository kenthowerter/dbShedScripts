...
--Script was found from a google search.  Seems a little old, but works with 2017
--Use on secondary or non-production environment to find non-sargable queries

--Read about SARGable and non-SARGable query 
--https://www.dbshed.com/article/13/SQL-Server/The-SARGable-Query
